...
class Playlist(models.Model):
    ...
    related = models.ManyToManyField("self", blank=True, related_name='related_playlist', through='PlaylistRelated') # Playlist of Movies and TvShows
    ...
    videos = models.ManyToManyField(Video, related_name='playlist_item', blank=True, through='PlaylistItem') # List of video for Seasons and Playlists
